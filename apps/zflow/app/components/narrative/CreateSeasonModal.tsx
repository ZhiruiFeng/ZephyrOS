        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className={`bg-gradient-to-r ${gradientClasses.background} px-6 py-4`}>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <SparklesIcon className="h-6 w-6 text-white" />
                    <h2 className="text-xl font-bold text-white">Create New Season</h2>
                  </div>
                  <button
                    onClick={handleClose}
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {Object.entries(SEASON_THEMES).map(([themeKey, themeConfig]) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="text-2xl" role="img" aria-label={themeConfig.name}>
                            {themeConfig.emoji}
                          </span>
                          <div>
                ...
                <div>
                  ...
                  {!title && (
                    <div className="mt-2">
                      <div className="mb-1 text-xs text-gray-500">Suggestions for {SEASON_THEMES[theme].name.toLowerCase()}:</div>
                ...
                <div>
                  ...
                  {!intention && (
                    <div className="mt-2">
                      <div className="mb-1 text-xs text-gray-500">Intention ideas:</div>
                      <div className="space-y-1">
                        {contentSuggestions.intentions.slice(0, 2).map((suggestion) => (
                          <button
                            key={suggestion}
                            type="button"
                            onClick={() => handleIntentionSuggestion(suggestion)}
                            className="block w-full rounded bg-gray-100 px-3 py-2 text-left text-xs text-gray-700 transition-colors hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                          >
                            {suggestion}
                          </button>
                        ))}
