export { default as CurrentView } from '../../modules/tasks/components/views/CurrentView'
export { default as FutureView } from '../../modules/tasks/components/views/FutureView'
