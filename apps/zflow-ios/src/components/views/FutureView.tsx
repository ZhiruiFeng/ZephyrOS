  ...
  if (loading) {
    return (
      <View style={styles.container}>
        <Text style={styles.loadingText}>Loading future tasks...</Text>
      </View>
    );
  }
  ...
  if (tasks.length === 0) {
    return (
      <View style={styles.emptyContainer}>
        <Text style={styles.emptyText}>No future tasks</Text>
        <Text style={styles.emptySubtext}>Backlog items and tasks scheduled for later will appear here</Text>
      </View>
    );
  }
