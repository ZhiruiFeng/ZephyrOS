-- =====================================================
-- External AI Panel Database Schema
-- Version: 1.0.0
-- Created: 2025-01-15
-- Description: Database tables to support the External AI Panel module
-- =====================================================
...
-- Insert some default AI agents for demo purposes
-- Note: These will be created for each user when they first access the module
-- The actual insertion should be handled by the application logic
